...
import { useLoginMutation, useUpdateUserMutation } from "@/app/redux/features/api/codexiumApi";
...
import GoogleButton from "@/app/components/authButtons/googleButton";
...
const LoginForm: FC = () => {
    ...
    useEffect(() => {
        if (isSuccess && data?.token) {
            // Устанавливаем куки через сервер
