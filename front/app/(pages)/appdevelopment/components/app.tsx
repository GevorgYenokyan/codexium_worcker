      ...
      <div>
        <div className={classes["container"]}>
          <h2>
            ...
            <b>
              <ReactTyped
                strings={[`${translations[leng]["apptitle2"]}`]}
                typeSpeed={40}
          ...
          <p className={classes["subTitle"]}>
            {translations[leng]["appTitleText"]}
          </p>
          <div className={classes["description"]}>
            <p className={classes["desc"]}>{translations[leng]["appText1"]}</p>
            <p className={classes["desc"]}>{translations[leng]["appText2"]}</p>

            <p className={classes["our_app"]}>
              {translations[leng]["up_whyChoose"]}
            </p>

            <div className={classes["up_chooseContainer"]}>
              {translations[leng]["ourExp"].map((el: string, i: number) => {
                return (
            ...
            <h2>
              <p className={classes.our_approach}>
                {translations[leng]["appProcess"]}
              </p>
            </h2>
            <div className={classes["processContainer"]}>
              {translations[leng]["appProcessItems"].map(
                (el: any, i: number) => {
                  return (
            ...
            <div className={classes["chooseContainer"]}>
              {translations[leng]["whyChooseItemsApp"].map(
                (el: string, i: number) => {
                  return (
                    <div key={i} className={classes["chooseItem"]}>
                      <Image
        ...
        <div className={classes["business"]}>
          <p className={classes["businessContainer"]}>
            {translations[leng]["yourBusinessApp"]}
          </p>
          <Image
